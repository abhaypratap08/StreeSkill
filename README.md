...
- Course details & documentation  
- Media structure (without large video files)  
- Scripts, captions, and thumbnails  
- Future website/app code  

---

## Project Status
Phase: Initial Setup  
Creating base structure, documentation, and content workflow.
